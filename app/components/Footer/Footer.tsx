    ...
    <footer className="bg-slate-900 text-white">
      <div className="mx-auto max-w-7xl py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h4 className="font-medium text-lg mb-4 text-orange-500">
              About 24 Hectares
            </h4>
            <p className="text-sm mb-4">
              At 24 Hectares, we enable agents , Developers, Builders to
              maximize the value of buying and selling real estate through our
              innovative primary and resale marketplaces.
            </p>
            <br />
            <Image
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 text-sm">
              {[
                ...
                <p
                  key={index}
                  onClick={(e) => redirectProperties(city)}
