...
const Login = () => {
  ...
  // Call hook only once and handle fallback
  let rawListingData = useAppSelector(selectPropertyListing);
  let listingData = Array.isArray(rawListingData) ? rawListingData : [];
