    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            ...
            <Image src={"/assets/logo/logo.png"} alt={'24 Hectors'} height={80} width={80} ></Image>
                ...
                <a href="javascript:;"  className=" mt-12 py-2.5 px-5 h-9 block w-fit bg-orange-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                    Contact us
                </a>
            </div>
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    ...
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Agent</a></li>
                    <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Builders</a></li>
                    <li><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Developers</a></li>
                </ul>
            </div>
            <div className="lg:mx-auto text-left ">
            ...
            <div className="lg:mx-auto text-left">
                ...
                <ul className="text-sm  transition-all duration-500">
                    ...
                    <li className="mb-6 hover:text-blue-800"><Link href={"/privacypolicy"}>Privacy Policy  </Link></li>
                    <li className="mb-6 hover:text-blue-800 "><Link href={"/termsandconditions"}>Terms And conditions</Link></li>
                    <li className="mb-6 hover:text-blue-800 "><Link href={"/refundpolicy"}>Refund Policy</Link></li>
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">24 Hectares</a> 2024, All rights reserved.</span>
