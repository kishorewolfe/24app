...
const NavHeader = () => {
  ...
  let menuDetails= menuData
  if(isLoggedIn){
    menuDetails = menuDataLoggedIn
  }
  else{
        ...
        <div className="container ">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                  <Image src={"/assets/logo/logo.png"} alt={'24 Hectors'} height={80} width={80}  className="p-2 mx-24"></Image>
              </Link>
            </div>
            <div className="flex w-full items-center justify-between px-4">
              ...
              {isLoggedIn ===false ?( <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/login"
